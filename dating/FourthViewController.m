...
- (IBAction)supportButton
{
    ...
    [picker setToRecipients:[NSArray arrayWithObjects:string, nil]];
    [picker setSubject:@"support for nutrition+"];
...
{
    UIAlertView *fullAlert = [[UIAlertView alloc] initWithTitle:@"About nutrition+" message:@"© Copyright 2012, Apollo Software Solutions, All Rights Reserved. nutrition+™ is a registered trademark of Amit Apollo Barman™." delegate:nil cancelButtonTitle:@"Close" otherButtonTitles:nil];
